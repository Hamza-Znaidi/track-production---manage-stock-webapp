    ...
    <>
      ...
      <div className="p-6 border-b border-gray-200 mt-10">
        <div className="flex items-center space-x-3">
          <div className="bg-indigo-600 w-10 h-10 rounded-lg flex items-center justify-center modern-hover">
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 bg-indigo-600 text-white p-3 rounded-lg shadow-lg hover:bg-indigo-700 transition-all duration-300 modern-hover modern-pulse"
      >
        {isMobileMenuOpen ? (
      ...
      {/* Overlay for mobile */}
      <div
        className={`lg:hidden fixed inset-0 backdrop-blur-md bg-black/30 z-30 transition-opacity duration-300 ease-in-out ${
      ...
      {/* Mobile Sidebar */}
      <aside
        className="lg:hidden w-64 bg-white shadow-lg h-screen fixed left-0 top-0 flex flex-col z-40 will-change-transform"
        style={{
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex w-64 bg-white shadow-lg h-screen fixed left-0 top-0 flex-col z-30">
        {sidebarContent}
      </aside>
    </>
  );
