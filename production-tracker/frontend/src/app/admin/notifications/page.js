          ...
          <div className="px-4 sm:px-8 py-6 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-red-100 border border-red-200 text-red-700 rounded-lg hover:bg-red-700 hover:text-white transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Clear All
              </button>
            </div>
          ...
          {notifications.length === 0 ? (
            ...
            <div className="space-y-3">
              {notifications.map((notification) => (
                <div
                  key={notification.id}
                  className={`bg-white rounded-xl shadow-sm border p-4 ${notification.isRead ? 'border-gray-100' : 'border-indigo-200'}`}
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {deletingId === notification.id ? 'Deleting...' : <Trash2 className="w-4 h-4" />}
                      </button>
                    </div>
                  </div>
                </div>
